...
//                    if (p.tongnap < 9999) {
//                        p.session.sendMessageLog("Yêu cầu nạp tối thiểu 10k để mở shinwa");
//                        return;
//                    }
...
//                    p.session.sendMessageLog("Shinwa Đang Bảo Trì Sửa Chữa !");
//                    if (p.tongnap < 9999) {
//                        p.session.sendMessageLog("Yêu cầu nạp tối thiểu 10k để mua vật phẩm shinwa");
//                        return;
//                    }
        ...
        try {
            if(player != null && player.nj != null && player.session != null && !player.nj.isDie && m != null && m.reader().available() > 0) {
                ...
                switch (type) {
                    ...
                    case 5:{
                        GameScr.LuyenBikip(player);
                        break;
                    }
                    case 6: {
                        GameScr.HuyPet(player);
                        break;
                    }
                    case 7:{
                        GameScr.LuyenPet(player);
                        break;
                    }
                    case 8:{
                        GameScr.LuyenMeDayHoa(player);
                        break;
                    }
                    case 9:{
                        GameScr.LuyenMeDayThuy(player);
                        break;
                    }
                    case 10:{
                        GameScr.LuyenMeDayPhong(player);
                        break;
                    }
                    case 11:{
                        GameScr.HuyMeDay(player);
                        break;
                    }
                    case 12:{
                        GameScr.LuyenMat(player);
                        break;
                    }
                    case 13:{
                        GameScr.NangMat(player);
                        break;
                    }
                    case 14:{
                        GameScr.HuyMat(player);
                        break;
                    }
                    default: {
                        break;
